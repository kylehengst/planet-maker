...
var Controls = function (app) {
  ...
  this.randomizeAll = function () {
    ...
    this.landColor1 = utilites.randomRGB();
    this.landColor2 = utilites.randomRGB();
    ...
    this.waterDeep = utilites.randomRGB();
    this.waterShallow = utilites.randomRGB();
    this.waterLevel = 0;
    if (Math.random() < 0.5) {
    ...
    this.cloudColor = utilites.randomRGB();
